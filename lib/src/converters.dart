...
extension ConverterForBytes on Uint8List {
  String get toSha256Base64 =>
      convert.base64.encode(SHA256Digest().process(this));
          ...
          try {
            if (value is String &&
              ...
              return bool.tryParse(value) ?? value;
                ...
                RegExp('^[0-9]{1,}\$').hasMatch(value)) {
              return int.tryParse(value) ?? value;
            } else if (value is String &&
                RegExp('^[0-9]{1,}\\.[0-9]{1,}\$').hasMatch(value)) {
