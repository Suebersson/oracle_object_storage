  ...
  factory RenameObject({
    ...
    */
    ...
    return RenameObject._(
      ...
      newPublicUrlFile: '${storage.apiUrlOrigin}${storage.bucketPath}/o/${details.details['newName']}',
      oldPublicUrlFile: '${storage.apiUrlOrigin}${storage.bucketPath}/o/${details.details['sourceName']}',
